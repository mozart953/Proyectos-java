...
public class ColorRGB {
    ...
    /**
     * Indica el color maximo admitido que puede tomar R,G o B.
     */
    private double maxColorRGB; //Coordenada Maxima para RGB
    /**
     * Indica el color minimo admitido que puede tomar R,G o B.
     */
    private double minColorRGB; //Coordenada Minima para RGB
    /**
     * Indica el color maximo admitido que puede tomar R.
     */
    private double maxColorR; //Coordenada Maxima para RGB
    /**
     * Indica el color minimo admitido que puede tomar R.
     */
    private double minColorR; //Coordenada Minima para RGB
    /**
     * Indica el color maximo admitido que puede tomar G.
     */
    private double maxColorG; //Coordenada Maxima para RGB
    /**
     * Indica el color minimo admitido que puede tomar G.
     */
    private double minColorG; //Coordenada Minima para RGB
    /**
     * Indica el color maximo admitido que puede tomar B.
     */
    private double maxColorB; //Coordenada Maxima para RGB
    /**
     * Indica el color minimo admitido que puede tomar B.
     */
    private double minColorB; //Coordenada Minima para RGB
    ...
    /**
     * Almacena de forma ordenada a un cambio que sufen R,G y B para que se
     * pueda sistematizar muy facíl.
     * <p>
     * en vez de hacer referencia a una variable se hace referencia a una
     * posicion.
     * <p>
     ...
     *
     *
     * @param color Color del que extraera las coordenadas RGB.
     */
     ...
     *
     *
     * @param Color dato de tipo <code>ColorRGB</code> del que extraera las
     * coordenadas RGB.
     * @see #Canal_Obtener
     */
 ...
 <p>
     ...
     * velocidades y el punto rebote por el espacio RGB de forma impredesible.
     *
     * <p>
     * <A href="http://www.youtube.com/c/JeffAporta">Jeff Aporta - YouTube</A>
     * <p>
